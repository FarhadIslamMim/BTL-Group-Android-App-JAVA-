...
public class Depot extends RealmObject {
    ...
    private String trade_lic_url;
    private String security_check_url;
    private String agreement_url;
    private String tin_url;
    ...
    public String getTrade_lic_url() {
        return trade_lic_url;
    }

    public void setTrade_lic_url(String trade_lic_url) {
        this.trade_lic_url = trade_lic_url;
    }

    public String getSecurity_check_url() {
        return security_check_url;
    }

    public void setSecurity_check_url(String security_check_url) {
        this.security_check_url = security_check_url;
    }
    ...
    public String getTin_url() {
        return tin_url;
    }

    public void setTin_url(String tin_url) {
        this.tin_url = tin_url;
    }
