...
/**
 * Created by monir.sobuj on 12/6/2017.
 */

public class SharedPrefsUtils {

    public static final String FCM_TOKEN = "sspl_fcm_token";

    public static final String ENABLE_AUTO_SYNC = "edcr_enable_auto_sync";
