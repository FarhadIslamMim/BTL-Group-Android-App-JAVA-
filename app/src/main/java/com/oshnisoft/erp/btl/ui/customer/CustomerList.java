...
public class CustomerList implements IItem<CustomerList, CustomerList.ViewHolder> {
    ...
    @Override
    public CustomerList withTag(Object tag) {
        this.tag = tag;
        return this;
    }
    ...
    @Override
    public CustomerList withEnabled(boolean enabled) {
    ...
    @Override
    public CustomerList withSetSelected(boolean selected) {
        isSelected = selected;
        return this;
    }
    ...
    @Override
    public CustomerList withSelectable(boolean selectable) {
    ...
    public void unbindView(ViewHolder holder) {
        ...
        //holder.txtTotalOrder.setText(null);
    ...
    @Override
    public CustomerList withIdentifier(long identifier) {
        return this;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ImageView ivCall, ivOrder, ivService, ivMeter;
        public ViewHolder(View itemView) {
            ...
            ivMeter                                             = itemView.findViewById(R.id.ivMeter);
